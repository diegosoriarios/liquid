...
class ChatMessageListItem extends StatelessWidget {
  ...
  Widget _showSentMessage({ EdgeInsets padding, TextAlign textAlign }) {
    ...
    return ListTile(
      ...
      leading: Text(formattedDate, textAlign: TextAlign.center, style: TextStyle(fontSize: 12)),
    );
  }
  ...
  Widget _showReceivedMessage() {
    ...
    return ListTile(
      ...
      trailing: Text(formattedDate, textAlign: TextAlign.center, style: TextStyle(fontSize: 12)),
    );
  }
}